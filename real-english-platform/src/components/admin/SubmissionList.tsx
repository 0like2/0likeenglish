...
import { Trash2, RotateCcw, Eye, User, Calendar, Award } from "lucide-react";
...
export default function SubmissionList({ submissions, type }: SubmissionListProps) {
                    ...
                    >
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                {sub.studentEmail && (
                                    <span className="text-sm text-slate-400">({sub.studentEmail})</span>
                                )}
                            </div>
            ...
            <AlertDialog open={!!deleteTarget} onOpenChange={() => setDeleteTarget(null)}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            <strong>{deleteTarget?.studentName}</strong>의 "{deleteTarget?.title}" 제출 기록을 삭제하시겠습니까?
                            <br />
            ...
            <AlertDialog open={!!resetTarget} onOpenChange={() => setResetTarget(null)}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            <strong>{resetTarget?.studentName}</strong>의 "{resetTarget?.title}" 진행 상황을 초기화하시겠습니까?
                            <br />
